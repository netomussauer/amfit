...
| **3 — Diferenciais** | ~~White Label~~ ✅, Coach por vídeo, IA para fichas (Claude API), ~~módulo financeiro~~ ✅ (cobrança manual — integração real com Asaas fica para uma próxima fatia) | Em andamento |
